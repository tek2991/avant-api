...
class QuestionPaperController extends Controller
{
    ...
    public function view(Request $request, ExamSubject $examSubject)
    {
        if (strpos($request->pat, '|') === false) {
            return response([
                'header' => 'Forbidden',
        ...
        return view('documents.question_paper', compact('exam', 'variables', 'examSubject', 'exam_questions', 'view'));
    }
}
