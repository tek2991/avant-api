...
class DownloadResultController extends Controller
{
    ...
    public function student(Request $request)
    {
        ...
        $file_name = 'Report_Card_'. str_replace(" ","_", $exam->name) . '_'. str_replace(" ","_", $exam->session->name) . '_' . $user->student->sectionStandard->standard->name . '_' . str_replace(" ","_", $user->userDetail->name) . '.pdf';
