...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::apiResource('chapter', ChapterController::class)->except(['index'])->middleware(['can:chapter_crud']);
    Route::get('chapter', [ChapterController::class, 'index'])->middleware(['can:chapter_read']);
    Route::get('chapter-all/{subject}', [ChapterController::class, 'all'])->middleware(['can:chapter_read']);
